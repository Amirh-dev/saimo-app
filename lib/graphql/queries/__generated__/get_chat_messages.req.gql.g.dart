...
part of 'get_chat_messages.req.gql.dart';
...
class _$GGetChatMessagesReqSerializer
  ...
  @override
  final String wireName = 'GGetChatMessagesReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GGetChatMessagesReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GGetChatMessagesVars)),
      'operation',
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GGetChatMessagesData)));
    }
...
class _$GGetChatMessagesReq extends GGetChatMessagesReq {
  @override
  final _i3.GGetChatMessagesVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GGetChatMessagesData? Function(
      _i2.GGetChatMessagesData?, _i2.GGetChatMessagesData?)? updateResult;
  @override
  final _i2.GGetChatMessagesData? optimisticResponse;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GGetChatMessagesReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GGetChatMessagesReq')
          ..add('vars', vars)
...
class GGetChatMessagesReqBuilder
    implements Builder<GGetChatMessagesReq, GGetChatMessagesReqBuilder> {
  _$GGetChatMessagesReq? _$v;
  ...
  _i2.GGetChatMessagesData? Function(
      _i2.GGetChatMessagesData?, _i2.GGetChatMessagesData?)? _updateResult;
  _i2.GGetChatMessagesData? Function(
          _i2.GGetChatMessagesData?, _i2.GGetChatMessagesData?)?
  ...
  GGetChatMessagesReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GGetChatMessagesReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GGetChatMessagesReq build() => _build();

  _$GGetChatMessagesReq _build() {
